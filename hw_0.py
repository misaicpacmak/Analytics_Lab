...
# Подготовка датасета 
# Ниже представлен код, которым была сделана первоначальная выборка из исходного реестра ФНС.
# Для ускорения работы скрипта результат был сохранен в файл sample_50.csv.
